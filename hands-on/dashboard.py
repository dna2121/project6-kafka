...
consumer = Consumer({'bootstrap.servers': 'server', 'security.protocol': 'SASL_SSL', 'sasl.mechanisms': 'PLAIN', 'sasl.username': 'username', 'sasl.password': 'password', 'group.id': 'python_example_group_1', 'auto.offset.reset': 'earliest'})
# Set up a callback to handle the '--reset' flag.

# Subscribe to topic
consumer.subscribe(['denise-data-raw'])
div = Div(
    text='',
    width=120,
    height=35
